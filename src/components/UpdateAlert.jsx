...
const UpdateAlert = () => {
  ...
  return (
    <div className="container mx-auto px-4 md:px-8 lg:px-16 max-w-6xl">
      <nav className="flex justify-between items-center py-5 mb-8">
        <div className="logo">
      ...
      <div className="form-container bg-white rounded-lg shadow-md p-6 md:p-8">
        <h2 className="text-2xl font-bold mb-6 text-gray-800">Disaster Alert Form</h2>
      ...
      <div className="alerts-list mt-8">
        <h2 className="text-2xl font-bold mb-6 text-blue-600">Active Alerts</h2>
        {alerts.length > 0 ? (
          alerts.map((alert) => (
      ...
      <footer className="footer mt-8 py-5 flex justify-center space-x-6">
        <Link 
          to="/terms" 
